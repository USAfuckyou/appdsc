...
<template>
  <div class="detail-page">
    <!-- 详情页头部 -->
    <div class="detail-header" ref="header" :style="'background:rgba(255,255,255,'+bgOpacity+')'">
    ...
    <div class="detail-swiper" id="title0">
      <mt-swipe :auto="2000" :show-indicators="true">
        <mt-swipe-item v-for="(detailData,index) in detailDatas.gallery_list" :key="index">
    ...
    <div class="w detail-sale-info">
      ...
      <span>{{detailInfoDatas.province_name}}{{detailInfoDatas.city_name}}</span>
    </div>
    ...
    <!-- 发送给好友 -->
    <ShareInfo v-on:setShareInfoStatus="setShareInfoStatus" :showshareinfo="showShareInfo" />
    <!-- 海报组件 -->
    <SharePoster
      ...
      <mt-tab-container v-model="selected">
        ...
        <mt-tab-container-item id="tab2">
          <div class="attr-params">
            <table>
              <tr v-for="(attr,index) in detailDatas.attr_parameter" :key="index">
    ...
    <!-- 购买数量弹窗 -->
    <div class="detail-mask2" :class="showMask?'showhide':''" @click="hideMask"></div>
...
// console.log(Object.keys(cityDatas));
export default {
